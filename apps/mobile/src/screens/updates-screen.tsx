      ...
      <SafeArea>
        <View className="flex-row items-center gap-3 px-4 py-3">
          <Pressable
            ...
            transition
          >
            <Icon className="size-md text-foreground" name="ChevronLeft" />
          </Pressable>
          ...
          <View className="gap-3">
            ...
            <View className="flex-row gap-3">
              <Pressable
                ...
                transition
              >
                <Icon className="size-sm text-foreground" name="Download" />
              ...
              <Pressable
                ...
                transition
              >
                <Icon className="size-sm text-foreground" name="RotateCw" />
                <Text className="text-sm font-extrabold text-foreground">
                  Restart
                </Text>
              </Pressable>
