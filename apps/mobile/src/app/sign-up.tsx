    ...
    <View className="flex-1">
      <MobileScreen
        ...
        contentContainerStyle={{
          paddingBottom: step === "businessType" ? 112 : 40,
        }}
      ...
      >
        <AuthBrandHeader
          subtitle={
            step === "businessType"
              ? "Select the closest match. You can change it before creating your account."
              : step === "profile"
                ? "Tell us what you sell and how customers place orders."
                : step === "business"
                  ? "Next, tell us where your business operates."
