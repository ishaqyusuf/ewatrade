          ...
          <View className="gap-5 px-5 pb-6">
            ...
            <View className="gap-4">
              <FormField
                ...
                placeholder={String(paymentTotals.cash)}
                value={declaredCash}
              />
              <FormField
                inputMode="decimal"
                ...
                placeholder={String(paymentTotals.transfer)}
              ...
              {inventoryLines.length > 0 ? (
                <View className="gap-3">
                  {inventoryLines.map((line) => {
                    ...
                    const variance =
                      declaredQuantity - line.expectedQuantity;
            ...
            <FormField
              ...
              placeholder="Variance reason or handover note"
              value={note}
            />
