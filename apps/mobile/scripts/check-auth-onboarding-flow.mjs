...
const CONTRACTS = [
  {
    ...
    markers: [
      ...
      '<Stack.Screen name="staff-onboarding"',
    ],
    reason:
  ...
  },
  {
    ...
    reason:
      "signup must stay light: Google plus name, email address, and business name for email OTP",
  },
  {
    ...
    reason:
      "OTP verification must keep separated OTP entry, auto-submit, resend, production verify, and local fallback behavior",
  },
  {
