...
export function initStorefrontObservability(client = false) {
  Sentry.init(
    sentryRuntimeOptions("storefront", {
...
export function captureStorefrontError(error: unknown, operation: string) {
