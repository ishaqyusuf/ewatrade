...
export function initMarketingObservability(client = false) {
  Sentry.init(
    sentryRuntimeOptions("marketing", {
...
export function captureMarketingError(error: unknown, operation: string) {
