...
- Retail Ops stock-wallet sale deduction and returns, full closeout approval tables, remaining sync event types, and shared-link customer account completion
- Orders and checkout
