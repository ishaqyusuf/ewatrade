...
if ((await board.textContent("#current-name")) !== "Open Stall") throw new Error("Previous chevron did not wrap from A to E")
await board.click("#next")
await board.click("#next")
if ((await board.textContent("#current-name")) !== "Counter Pulse") throw new Error("Next chevron did not advance from A to B")
