...
is idempotent. The verified Neon development dataset contains no legacy rows, so
production reconciliation and a direct end-to-end Service Request lifecycle
regression remain open; ticket 10 owns compatibility removal after that rollout.
