...
11, 03A, 05, 06, 06A, 06B, 08, 07 and 09 are complete. Tickets 04 and 04A have
source-complete foundations; their remaining recommendation/live-provider
release gates stay open. Tickets 10 and 12 are the next dependency-ready source
frontiers. Any scope or dependency change should update the spec, ADR/Brain and
