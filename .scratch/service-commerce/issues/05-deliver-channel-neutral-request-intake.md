...
- [ ] Test all three origins for exact Product demand, any approved Product inquiry, Generic Service and the compatible Pharmacy path, including cross-Tenant routing and inactive Store rejection.
